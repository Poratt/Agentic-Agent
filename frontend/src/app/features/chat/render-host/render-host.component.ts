    ...
    template: `
        <div class="render-host-root">
            @switch (componentType()) {
                ...
                @case ('auth-url') {
                    <app-auth-url-card [data]="$any(renderData())" />
                }
                @default {
