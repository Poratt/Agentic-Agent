...
@Component({
  ...
  styleUrls: ['./design-system.css', './_design-system-showcase.css', './_design-system-buttons.css', './_design-system-tokens.css'],
})
export class DesignSystem {
  ...
  private refreshTokenValues(): void {
    ...
    this.colorGroups.update(groups => groups.map(group => ({
      ...group,
